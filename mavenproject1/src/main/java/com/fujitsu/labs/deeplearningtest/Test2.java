...
public class Test2 {
    ...
    public static final char[] LEARNSTRING = "こんにちは、こんばんは、こにゃにゃちは、おはようございます。日経不動産マーケット情報のサイトをご利用いただくためのIDは、日経不動産マーケット情報のご購読1部につき1つを発行しています。ご購読いただくと、当サイトで過去の記事（売買事例や移転事例など）がご覧いただけるほか、検索機能もご利用いただけます。すでにご購読いただいている方は、上記の会員登録・変更ボタンをクリックしてウェブサイトの会員登録をしてください。登録済みの方は、上記のログインボタンをクリックしてください。".
            toCharArray();
    ...
    public static void main(String[] args) throws FileNotFoundException,
        ...
        for (int i = 0; i < HIDDEN_LAYER_CONT; i++) {
            ...
            hiddenLayerBuilder.nIn(
                    i == 0 ? LEARNSTRING_CHARS_LIST.size() : HIDDEN_LAYER_WIDTH);
